/* LOSY Turbo SW v60: Network-First for HTML + Stale-While-Revalidate for Assets
   Гарантирует 100% свежесть игровых режимов и оболочки без устаревшего кэша. */

const CACHE = 'losy-turbo-cache-v60';

const PRECACHE_ASSETS = [
  '/',
  '/dist/shell.bundle.css?v=60',
  '/dist/app.bundle.js?v=60',
  ...
  '/modes/losy-upgrade-v24.html?v=60',
  '/modes/losy-bombs.html?v=60',
  '/modes/losy-rocket.html?v=60'
];
